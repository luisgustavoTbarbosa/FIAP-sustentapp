...
export default function Sidebar() {
    ...
    function getHref() {
        ...
        let indexProfile = href.indexOf('/perfil');
    ...
    return (
        <nav className="sidebar">
            <div className="nav-button home" onClick={mudandoCor}>
            ...
            <div className="nav-button explore" onClick={mudandoCor}>
                <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="nav-button profile" onClick={mudandoCor}>
