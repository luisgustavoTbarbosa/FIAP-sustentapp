...
export default class Perfil extends Component {
    state = {
        useAboutOrData: 'about'
    };

    teste() {
        let { useAboutOrData } = this.state;
        console.log(useAboutOrData)
    }
    ...
    itemSelectActive = (e) => {
        ...
        selectItems.forEach((item) => {
            ...
            if(item === e.target) {
                ...
                console.log(e.target.classList.toString().indexOf("data"))
                if(e.target.classList.toString().indexOf("data") === -1) {
                    console.log('Sobre')
                    this.setState({
                        useAboutOrData: 'about'
                    })
                    ...
                    <header className="header">
                        ...
                        <div className="sub-info">
                            ...
                            <div className="container-select">
                                <div className="select-item about active" onClick={(e) => this.itemSelectActive(e)}>Sobre</div>
                                <div className="select-item data" onClick={(e) => this.itemSelectActive(e)}>Dados</div>
                            </div>
                        </div>
                    </header>
                    <main>
                        {/*  <FormProfile />*/}
                        {/* <CarouselProfile /> */}
                        { useAboutOrData !== 'about' ? <FormProfile /> : <CarouselProfile /> }
                    </main> 
                </div>
                <Sidebar />
            </>
