...
export default function Perfil() {
    const [useAboutOrData, setUseAboutOrData] = React.useState('about');
        ...
        selectItems.forEach((item) => {
            ...
            if(item === e.target) {
                ...
                if(e.target.classList.toString().indexOf("data") === -1) {
                    setUseAboutOrData('about')
                } else {
                    setUseAboutOrData('data')
                }
            }
        })
    }
                ...
                <header className="header">
                    ...
                    <div className="sub-info">
                        ...
                        <div className="container-select">
                            <div className="select-item about active" onClick={(e) => itemSelectActive(e)}>Sobre</div>
                            <div className="select-item data" onClick={(e) => itemSelectActive(e)}>Dados</div>
                        </div>
                    </div>
                </header>
                <main>
